...
namespace Eraware.Modules.Html5Video
{
    ...
    /// 
    /// Because the control inherits from Html5VideoSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : Html5VideoModuleSettingsBase
    {
